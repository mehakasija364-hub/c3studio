...
const PRODUCTS = [
  ...
  {id:"154",name:"Mini Teddy Gift Box Peach",slug:"mini-teddy-gift-box-peach",price:650,oldPrice:700,image:"/images/kidsreturn4.jpg",category:"Birthday",subcategory:["Kids Return Favours","Birthday"],tagline:"Elegant teddy hamper in soft tones",description:"Aesthetic transparent box with a peach teddy, styled with white fillers and finished with a soft pink ribbon bow.",details:["Transparent box with lid","Peach teddy centerpiece","White filler decoration","Pink ribbon bow styling","Perfect premium return gift"]},
   ...
   //birthday boy
  {id:"161",slug:"royal-boss-baby-blue-cart-hamper",name:"Royal Boss Baby Blue Cart Hamper",price:1799,image:["/images/babyboy1.jpg","/images/babyboy1.2.jpg"],category:["Occasions","Birthday"],subcategory:["Baby Shower And Baby Announcement/ Baby Arrival","First Birthday — Boy"],tagline:"Stylish boss baby vibes in blue",description:"Premium boss baby themed cart hamper with cute decor, treats and personalized elements.",details:["Designer cart base","Boss baby theme cutouts","Snack jars & goodies","Mini plant decor","Custom name tag"]},
  {id:"162",slug:"blue-boss-baby-basket-favours",name:"Blue Boss Baby Basket Favours",price:1499,image:["/images/babyboy2.jpg","/images/babyboy2.2.jpg"],category:["Occasions","Birthday"],subcategory:["Baby Shower And Baby Announcement/ Baby Arrival","First Birthday — Boy"],tagline:"Cute return favours with boss charm",description:"Adorable mini basket hampers in boss baby theme, filled with treats for baby boy celebrations.",details:["Handwoven baskets","Boss baby tags","Snack jars","Balloon accents","Return favour setup"]},
  {id:"163",slug:"jungle-baby-favour-baskets",name:"Jungle Baby Favour Baskets",price:1299,image:["/images/babyboy3.jpg","/images/babyboy3.2.jpg"],category:["Occasions","Birthday"],subcategory:["Baby Shower And Baby Announcement/ Baby Arrival","First Birthday — Boy"],tagline:"Wild jungle cuteness for celebrations",description:"Fun jungle theme hampers with animal accents and goodies, perfect for baby boy birthdays and return gifting.",details:["Jungle theme cutouts","Woven baskets","Snack jars","Green ribbon styling","Thank you cards"]},
   ...
   //birthday girl
  {id:"181",slug:"princess-glass-luxury-hamper-box",name:"Princess Glass Luxury Hamper Box",price:1899,image:["/images/babygirl1.jpg","/images/babygirl1.1.jpg"],category:["Occasions","Birthday"],subcategory:["Baby Shower And Baby Announcement/ Baby Arrival","First Birthday — Girl"],tagline:"Elegant glass hamper for baby princess",description:"Premium transparent box hamper with floral styling, jars and personalized details.",details:["Luxury glass box","Floral decor","Snack jars","Custom name tag","Premium finish"]},
  ...
  {id:"188",slug:"pastel-butterfly-return-hamper",name:"Pastel Butterfly Return Hamper",price:899,image:["/images/birthdaygirl2.webp"],category:["Occasions","Birthday"],subcategory:["Baby Shower And Baby Announcement/Baby Arrival","First Birthday — Girl","Kids Return Favours"],tagline:"Sweet memories in pastel charm",description:"A cute pastel-themed return hamper with jars and treats, perfect for kids’ birthdays.",details:["Decorative pastel box","2 Glass jars with chocolates","Shredded filler","Personalized thank you card","Ribbon bow packaging"]}, 
